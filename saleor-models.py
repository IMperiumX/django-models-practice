...
class AccountCustomernote(models.Model):
    ...
    user = models.ForeignKey('AccountUser', models.DO_NOTHING, related_name='accountcustomernote_user_set', blank=True, null=True)
...
class AccountGroupChannels(models.Model):
    group = models.ForeignKey(AccountGroup, models.DO_NOTHING)
...
class AccountGroupPermissions(models.Model):
    group = models.ForeignKey(AccountGroup, models.DO_NOTHING)
    permission = models.ForeignKey('PermissionPermission', models.DO_NOTHING)
...
class AccountUser(models.Model):
    ...
    default_shipping_address = models.ForeignKey(AccountAddress, models.DO_NOTHING, related_name='accountuser_default_shipping_address_set', blank=True, null=True)
    ...
    external_reference = models.CharField(unique=True, max_length=250, blank=True, null=True)
...
class AttributeAttributevalue(models.Model):
    ...
    reference_page = models.ForeignKey('PagePage', models.DO_NOTHING, blank=True, null=True)
    reference_product = models.ForeignKey('ProductProduct', models.DO_NOTHING, blank=True, null=True)
    plain_text = models.TextField(blank=True, null=True)
    reference_variant = models.ForeignKey('ProductProductvariant', models.DO_NOTHING, blank=True, null=True)
    external_reference = models.CharField(unique=True, max_length=250, blank=True, null=True)
...
class ChannelChannel(models.Model):
    ...
    automatically_fulfill_non_shippable_gift_card = models.BooleanField(blank=True, null=True)
...
class CheckoutCheckout(models.Model):
    ...
    shipping_address = models.ForeignKey(AccountAddress, models.DO_NOTHING, related_name='checkoutcheckout_shipping_address_set', blank=True, null=True)
...
class CheckoutCheckoutline(models.Model):
    ...
    checkout = models.ForeignKey(CheckoutCheckout, models.DO_NOTHING)
    variant = models.ForeignKey('ProductProductvariant', models.DO_NOTHING)
    price_override = models.DecimalField(max_digits=12, decimal_places=3, blank=True, null=True)
    created_at = models.DateTimeField()
...
class DiscountCheckoutdiscount(models.Model):
    ...
    promotion_rule = models.ForeignKey('DiscountPromotionrule', models.DO_NOTHING, blank=True, null=True)
...
class DiscountCheckoutlinediscount(models.Model):
    ...
    translated_name = models.CharField(max_length=255, blank=True, null=True)
    reason = models.TextField(blank=True, null=True)
    line = models.ForeignKey(CheckoutCheckoutline, models.DO_NOTHING, blank=True, null=True)
...
class DiscountOrderlinediscount(models.Model):
    ...
    translated_name = models.CharField(max_length=255, blank=True, null=True)
    reason = models.TextField(blank=True, null=True)
    line = models.ForeignKey('OrderOrderline', models.DO_NOTHING, blank=True, null=True)
    promotion_rule = models.ForeignKey('DiscountPromotionrule', models.DO_NOTHING, blank=True, null=True)
    sale_id = models.IntegerField(blank=True, null=True)
    voucher = models.ForeignKey('DiscountVoucher', models.DO_NOTHING, blank=True, null=True)
    voucher_code = models.CharField(max_length=255, blank=True, null=True)
...
class DiscountPromotionrule(models.Model):
    ...
    reward_value = models.DecimalField(max_digits=12, decimal_places=3, blank=True, null=True)
    promotion = models.ForeignKey(DiscountPromotion, models.DO_NOTHING)
...
class GiftcardGiftcard(models.Model):
    ...
    used_by = models.ForeignKey(AccountUser, models.DO_NOTHING, related_name='giftcardgiftcard_used_by_set', blank=True, null=True)
...
class OrderOrder(models.Model):
    ...
    id = models.UUIDField(primary_key=True)
    billing_address = models.ForeignKey(AccountAddress, models.DO_NOTHING, blank=True, null=True)
    shipping_address = models.ForeignKey(AccountAddress, models.DO_NOTHING, related_name='orderorder_shipping_address_set', blank=True, null=True)
    user = models.ForeignKey(AccountUser, models.DO_NOTHING, blank=True, null=True)
    total_net_amount = models.DecimalField(max_digits=12, decimal_places=3)
    voucher = models.ForeignKey(DiscountVoucher, models.DO_NOTHING, blank=True, null=True)
    language_code = models.CharField(max_length=35)
    ...
    channel = models.ForeignKey(ChannelChannel, models.DO_NOTHING)
    redirect_url = models.CharField(max_length=200, blank=True, null=True)
    shipping_tax_rate = models.DecimalField(max_digits=5, decimal_places=4, blank=True, null=True)
    ...
    shipping_tax_class = models.ForeignKey('TaxTaxclass', models.DO_NOTHING, blank=True, null=True)
...
class OrderOrdergrantedrefund(models.Model):
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()
    amount_value = models.DecimalField(max_digits=12, decimal_places=3)
    currency = models.CharField(max_length=3)
...
class OrderOrdergrantedrefundline(models.Model):
    quantity = models.IntegerField()
    granted_refund = models.ForeignKey(OrderOrdergrantedrefund, models.DO_NOTHING)
    order_line = models.ForeignKey('OrderOrderline', models.DO_NOTHING)
    reason = models.TextField(blank=True, null=True)
...
class OrderOrderline(models.Model):
    ...
    tax_rate = models.DecimalField(max_digits=5, decimal_places=4, blank=True, null=True)
    ...
    undiscounted_base_unit_price_amount = models.DecimalField(max_digits=12, decimal_places=3)
    metadata = models.JSONField(blank=True, null=True)
    private_metadata = models.JSONField(blank=True, null=True)
...
class PermissionPermission(models.Model):
    name = models.CharField(max_length=255)
...
class ProductVariantchannellistingpromotionrule(models.Model):
    ...
    currency = models.CharField(max_length=3)
    promotion_rule = models.ForeignKey(DiscountPromotionrule, models.DO_NOTHING)
    variant_channel_listing = models.ForeignKey(ProductProductvariantchannellisting, models.DO_NOTHING)
...
class SchedulersCustomperiodictask(models.Model):
    periodictask_ptr = models.OneToOneField(DjangoCeleryBeatPeriodictask, models.DO_NOTHING, primary_key=True)
    custom = models.ForeignKey('SchedulersCustomschedule', models.DO_NOTHING, blank=True, null=True)
...
class SiteSitesettings(models.Model):
    ...
    top_menu = models.ForeignKey(MenuMenu, models.DO_NOTHING, related_name='sitesitesettings_top_menu_set', blank=True, null=True)
    display_gross_prices = models.BooleanField()
...
class TaxTaxconfiguration(models.Model):
    ...
    channel = models.OneToOneField(ChannelChannel, models.DO_NOTHING)
...
class ThumbnailThumbnail(models.Model):
    ...
    category = models.ForeignKey(ProductCategory, models.DO_NOTHING, blank=True, null=True)
    collection = models.ForeignKey(ProductCollection, models.DO_NOTHING, blank=True, null=True)
    product_media = models.ForeignKey(ProductProductmedia, models.DO_NOTHING, blank=True, null=True)
    user = models.ForeignKey(AccountUser, models.DO_NOTHING, blank=True, null=True)
    app = models.ForeignKey(AppApp, models.DO_NOTHING, blank=True, null=True)
    app_installation = models.ForeignKey(AppAppinstallation, models.DO_NOTHING, blank=True, null=True)
...
class WarehouseChannelwarehouse(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('warehouse', 'channel'), ('channel', 'warehouse'),)
